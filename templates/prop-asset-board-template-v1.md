...
风格锁：[根据道具与风格类型选取并填入标准双层架构风格锁，锁定不变画质控制量与变化变量参数，如：真人电影写实风格锁]
...
Style lock: [Select and fill standard decoupled style lock matching the art style and prop, locking rendering constants and style variables]
