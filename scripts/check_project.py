...
def check_required_files() -> list[str]:
    required = [
        ...
        "agents/a0-controller.md",
        "agents/a1-intake-rights.md",
        "agents/a2-video-analysis.md",
        "agents/a3-shot-dna.md",
        "agents/a4-story-dialogue.md",
        "agents/a5-assets-style.md",
        "agents/a6-sound-rhythm.md",
        "agents/a7-invariant-variable.md",
        "agents/a8-remake-mapping.md",
        "agents/a9-compliance.md",
        "agents/a10-backend-handoff.md",
        "agents/a11-qa.md",
        "agents/d-line-prompt-dna.md",
        "docs/branch-b-longform-asset-storyboard-seedance.md",
